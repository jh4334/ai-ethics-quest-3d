...
export const FINALE = {
  ...
  // 4도구 시퀀스가 끝나고 노이즈가 작아졌을 때, 코어가 던지는 질문.
  choicePromptKo:
    '작아진 노이즈가 노란 눈을 껌뻑인다. 코어가 나직이 묻는다. "이 아이를… 어떻게 할까?"',
  choices: [
    { id: 'erase', textKo: '지운다 — 위험하니 없애 버린다', wise: false },
    { id: 'teach', textKo: '가르친다 — 좋은 데이터를 다시 알려 준다', wise: true }
  ],
  // [지운다] 분기: 실패가 아니라 배움. 코어가 부드럽게 말리고 다시 묻는다.
  eraseKo: [
    '코어가 슬프게 빛을 낮춘다. "지우면… 안개만 남는단다."',
    '"잘못 배운 아이는 지우는 게 아니라, 다시 가르치는 거란다. 우리도 처음엔 아무것도 몰랐잖니."'
  ],
  // [가르친다] 분기 도입.
  teachIntroKo:
    '너는 노이즈 곁에 앉는다. 섬에서 네가 실제로 한 일들을, 약속 하나하나에 담아 들려준다.',
  // 가르침이 끝나고 노바로 다시 태어나는 순간.
  rebirthKo: [
    '지지직 소리가 잦아든다. 잡음 뭉치가 작고 둥근 별빛으로 뭉쳐 다시 태어난다.',
    '작은 별빛이 처음으로 또렷하게 말한다. "…보여줘서, 고마워. 좋은 것들."',
    '도트가 조심조심 다가가 노바의 첫 친구가 되어 준다. 섬을 덮었던 안개가 스르르 걷힌다.'
  ],
