...
> **2026-08-23 3D 팝업 동화 전환:** 현재 구현 기준은 [`docs/design/H17-AI-윤리-동화책-스토리바이블.md`](docs/design/H17-AI-윤리-동화책-스토리바이블.md)와 [`docs/design/H17-3D-동화책-제작-플랜.md`](docs/design/H17-3D-동화책-제작-플랜.md)다. 아래 2D 횡스크롤·전투 규칙은 회귀 확인을 위한 아카이브이며 새 루트 작품에 적용하지 않는다.
