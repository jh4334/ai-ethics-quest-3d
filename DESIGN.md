...
> **2026-08-23 탑다운 3D 동화 모험 전환:** 현재 구현 기준은 [`docs/design/H17-탑다운-동화-모험-재설계.md`](docs/design/H17-탑다운-동화-모험-재설계.md)와 [`docs/design/H17-AI-윤리-동화책-스토리바이블.md`](docs/design/H17-AI-윤리-동화책-스토리바이블.md)다. 아래 횡스크롤·팝업 동화 규칙은 회귀 확인을 위한 아카이브다.
