...
환경·퍼즐 소품은 코드 생성을 기본으로 하되, 리부트 1장 캠퍼스에는 위 Kenney CC0 GLB를 함께 사용한다. 외부 캐릭터는 남색 달빛 장면에 맞춘 역할별 색상과 체격만 런타임에서 조정한다.
